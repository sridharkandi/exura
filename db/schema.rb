...
ActiveRecord::Schema.define(:version => 20121231071023) do
  ...
  create_table "exura_price_options", :force => true do |t|
    t.integer  "price_on_sunday"
    t.integer  "price_on_monday"
    t.integer  "price_on_tuesday"
    t.integer  "price_on_wednesday"
    t.integer  "price_on_thursday"
    t.integer  "price_on_friday"
    t.integer  "price_on_saturday"
  ...
  create_table "spree_date_ranges", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
  ...
  create_table "spree_products", :force => true do |t|
    ...
    t.string   "level"
    t.integer  "min_passengers_reqd"
    t.integer  "max_passengers_reqd"
    t.integer  "min_age"
    t.integer  "max_age"
    t.string   "facilities"
    t.string   "items_to_bring"
    ...
    t.string   "city"
    t.integer  "duration"
    t.integer  "on_hand_on_sunday"
    t.integer  "on_hand_on_monday"
    t.integer  "on_hand_on_tuesday"
    t.integer  "on_hand_on_wednesday"
    t.integer  "on_hand_on_thursday"
    t.integer  "on_hand_on_friday"
    t.integer  "on_hand_on_saturday"
